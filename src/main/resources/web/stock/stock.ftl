<div style="margin: 10px">
        ...
        <form class="layui-form" action="javascript:;" id="selectStockForm">
            <div class="layui-form-item">
                <div class="layui-inline">
                    <label class="layui-form-label">仓库名</script></label>
                    <div class="layui-input-inline">
                        <input type="text" name="keyword" id="keyword" autocomplete="off" placeholder="请输入仓库名"
                               class="layui-input">
                    </div>
                </div>
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <select name="searchStockStatus" lay-search="">
                            <option value=""></option>
    ...
    <input id="addStockHidden" value="" hidden="hidden"></div>