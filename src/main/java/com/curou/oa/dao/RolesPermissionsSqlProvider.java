...
import com.curou.oa.models.RolesPermissionsExample.Criteria;
import com.curou.oa.models.RolesPermissionsExample.Criterion;
...
public class RolesPermissionsSqlProvider {
    ...
    public String countByExample(RolesPermissionsExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("roles_permissions");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(RolesPermissionsExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("roles_permissions");
        applyWhere(sql, example, false);
        return sql.toString();
    }
    ...
    public String selectByExample(RolesPermissionsExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        RolesPermissions record = (RolesPermissions) parameter.get("record");
        RolesPermissionsExample example = (RolesPermissionsExample) parameter.get("example");
        ...
        if (record.getPermId() != null) {
            sql.SET("perm_id = #{record.permId,jdbcType=VARCHAR}");
        }
    ...
    protected void applyWhere(SQL sql, RolesPermissionsExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
