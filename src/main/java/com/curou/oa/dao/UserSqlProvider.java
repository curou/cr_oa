...
import com.curou.oa.models.UserExample.Criteria;
import com.curou.oa.models.UserExample.Criterion;
...
public class UserSqlProvider {
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getMobilePhone() != null) {
            sql.SET("mobile_phone = #{record.mobilePhone,jdbcType=VARCHAR}");
        }
