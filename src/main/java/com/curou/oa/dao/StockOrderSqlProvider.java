...
import com.curou.oa.models.StockOrderExample.Criteria;
import com.curou.oa.models.StockOrderExample.Criterion;
import com.curou.oa.models.StockOrderExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class StockOrderSqlProvider {

    public String countByExample(StockOrderExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("stock_order");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(StockOrderExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("stock_order");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(StockOrder record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("stock_order");
    ...
    public String selectByExample(StockOrderExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        StockOrder record = (StockOrder) parameter.get("record");
        StockOrderExample example = (StockOrderExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("stock_order");
    ...
    public String updateByPrimaryKeySelective(StockOrder record) {
        SQL sql = new SQL();
        sql.UPDATE("stock_order");
    ...
    protected void applyWhere(SQL sql, StockOrderExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
